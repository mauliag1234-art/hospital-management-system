...
<title>View Wards | MediCore HMS</title>
...
<a href="add_ward.php" class="btn btn-primary">
...
<div class="col-md-4">
<input type="text" id="searchWard" class="form-control" placeholder="Search Ward...">
</div>

</div>

<?php
$query = "SELECT * FROM wards ORDER BY ward_id DESC";
...
<tr>
    ...
    <td>
        ...
        <a href="edit_ward.php?id=<?= $row['ward_id']; ?>" class="btn btn-warning btn-sm">
            <i class="fa-solid fa-pen"></i>
        </a>

        <a href="delete_ward.php?id=<?= $row['ward_id']; ?>"
